...
const Administration = () => {
  ...
  const vc = {
    ...
    text: ["Nasir Jamal Khattak, PhD (Amherst)", "Ph:  Office  +92.5822.960479", "Fax: +92.5822.960480", "Email: vice.chancellor@ajku.edu.pk"]
  }
          ...
          <div className="modern-nav">
            <ul className="modern-nav-list">
              {sections.map((section) => (
                <li key={section.id} className="modern-nav-item">
                  <button
