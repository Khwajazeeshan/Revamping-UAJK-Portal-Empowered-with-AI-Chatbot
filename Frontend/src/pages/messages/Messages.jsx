...
const Messages = () => {
    ...
    const vcmsg = [
        ...
        {
            description: "Nasir Jamal Khattak, PhD (Amherst)"
        },
        {
        ...
        <>
            <div className="messages-container">
                ...
                <Section2 subheading="Vision and Mission"
                    ...
                    bgclr="linear-gradient(90deg, #153fb1ff 0%, #16165aff 100%)" />
                ...
                <Section2 subheading="Core Values"
                    ...
                    bgclr="linear-gradient(90deg, #16165a 0%, #153fb1 100%)" />
            </div>
