  ...
  useEffect(() => {
    const fetchAdmissions = async () => {
      try {
        ...
        const response = await axios.get(`${server}/api/applications`, {
              ...
              <tbody>
                {admissions.map((admission) => (
                  <tr key={admission.cnic} className="ad-data-row">
                    ...
                    <td>
                      {admission.department1}, {admission.department2},{" "}
                      {admission.department3}
                    </td>
                    ...
                    <td>
                      {admission.transcriptPhoto ? (
                        <a
                          href={`${admission.transcriptPhoto}`}
                          target="_blank"
                          rel="noopener noreferrer"
                        >
                          Transcript
