...
const Register = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      formData.append("matricMarks", data.matricMarks);
      formData.append("fscMarks", data.fscMarks);
      ...
      formData.append("department3", data.department3);

      // file fields (IMPORTANT!)
      formData.append("profilePhoto", data.profilePhoto[0]);
      formData.append("matricDMCPhoto", data.matricDMCPhoto[0]);
      formData.append("fscDMCPhoto", data.fscDMCPhoto[0]);

      if (data.transcriptPhoto && data.transcriptPhoto.length > 0) {
        formData.append("transcriptPhoto", data.transcriptPhoto[0]);
      }
