            ...
            <div id="section15">
                <div className="main-footer">
                    ...
                    <div className="footer-menus-container">
                        ...
                        <div className="footer-menus">
                            <Link className="footer-links-hvr" to="/admission" onClick={scrollToTop}>Admission</Link>
                            ...
                            <Link className="footer-links-hvr" to="contact" onClick={scrollToTop}>Contact us</Link>
                        </div>
                ...
                <div className="footer-copyright">
                    ...
                    <p>Developed by: Khawaja Zeeshan & Zeeshan Younis</p>
                </div>
            </div>
        </>
    )
